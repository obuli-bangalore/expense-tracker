...
<h3 align="center" style="color:blue"><b>Datewise Expense Report from <?php echo date('d-m-Y',strtotime($original_date));?> to <?php echo date('d-m-Y',strtotime($original_date1));?></b></h3>
<hr />
