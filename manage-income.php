	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><b>Manage Income</b></li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading"><b>Manage Income</b></div>
...
?>
	 ...
	 <td><a href="update-income.php?delid=<?php echo $row['ID'];?>">Edit</a>
