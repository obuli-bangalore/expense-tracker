...
$msg="This email  associated with another account";
    ...
    $query=mysqli_query($con, "insert into tbluser(FullName,Age,Employed,Address,Email,MobileNumber,Password) value('$fname', '$age', '$employee','$address','$email', '$mobno','$password' )");
    if ($query) {
...
<body>
    ...
    echo $msg;
						...
						<fieldset>
							...
							<div class="form-group">
								<input class="form-control" placeholder="Age" name="age" type="text" required="true">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="Enter are you Employed Please enter Yes or No" name="employee" type="text" required="true">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="Address" name="address" type="text" required="true">
							</div>
							<div class="form-group">
